...
import VersenderDashboardClient from './_components/VersenderDashboardClient'

const VersenderDashboardPage = async () => {
    // Session prüfen
    ...
    // Prüfen, ob der Benutzer ein Versender ist
    if (company.type !== 'versender') {
        // Weiterleitung zum richtigen Dashboard basierend auf dem Unternehmenstyp
        redirect(company.type === 'subunternehmer' ? '/subunternehmer/dashboard' : '/admin/dashboard')
    }
...
export default VersenderDashboardPage 