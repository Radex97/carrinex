...
interface VersenderDashboardClientProps {
  user: User
  company: Company
  locations: CompanyLocation[]
}

const VersenderDashboardClient = ({ 
  user, 
  company, 
  locations 
}: VersenderDashboardClientProps) => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-6">Versender Dashboard</h1>
        ...
        <Card>
          <div className="p-6">
            ...
            <div className="mt-3">
              ...
              <p className="font-medium">Versender</p>
            </div>
            <div className="mt-3">
              <p className="text-sm text-gray-500">Branche</p>
              <p className="font-medium">
                {'industry' in company ? company.industry : 'Keine Branche angegeben'}
              </p>
            </div>
          </div>
        </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <Card>
          <div className="p-6">
            <h5 className="font-medium mb-4">Aktuelle Frachten</h5>
            <p className="text-gray-500">Noch keine Frachten ausgeschrieben.</p>
            <button 
              className="mt-4 px-4 py-2 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition-colors"
            >
              Neue Fracht ausschreiben
            </button>
          </div>
        </Card>
...
export default VersenderDashboardClient 