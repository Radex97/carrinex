...
interface SubunternehmerDashboardClientProps {
  user: User
  company: Company
  locations: CompanyLocation[]
}

const SubunternehmerDashboardClient = ({ 
  user, 
  company, 
  locations 
}: SubunternehmerDashboardClientProps) => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-6">Subunternehmer Dashboard</h1>
        ...
        <Card>
          <div className="p-6">
            ...
            <div className="mt-3">
              ...
              <p className="font-medium">Subunternehmer</p>
            </div>
          </div>
        </Card>
      ...
      <div className="mb-6">
        <Card>
          <div className="p-6">
            <h5 className="font-medium mb-4">Aktuelle Aufträge</h5>
            <p className="text-gray-500">Noch keine aktiven Aufträge.</p>
            <button 
...
export default SubunternehmerDashboardClient 